 		...
 		<div class="row">
 			<div class="col-md-6 col-sm-12">
 							...
 							<form action="" method="post" id="UbahDataSistemDokumen">
 								<div class="row">
 									<div class="form-group col-sm-12">
 										...
 										<input type="hidden" name="id" id="id" value="<?=$idName;?>">
 									...
 									<div class="form-group col-sm-12">
 										...
 										<input type="text" value="<?=$note;?>" name="keterangan" id="keterangan" class="form-control">
 									</div>
 									<div class="form-group col-sm-12">
 										<label> Kategori Foto</label>
 										<select name="ktd" id="ktd" class="form-control">
 											<option value="0">Pilih Kategori</option>
 											<option value="1"<?=$kategori_dokumentasi == 1 ?'selected' : '';?>>Haji</option>
 											<option value="2"<?=$kategori_dokumentasi == 2 ?'selected' : '';?>>Umroh</option>
 											<option value="3"<?=$kategori_dokumentasi == 3 ?'selected' : '';?>>Pariwisata</option>
 										</select>
 									</div>
 									<div class="form-group col-sm-12">
 				...
 				<div class="col-md-3">
 					<section class="boxs">
 						<div class="boxs-header">
 							<h3 class="custom-font hb-blue">
 								<strong>File Foto Lama</strong> </h3>
 							</div>
 							<div class="boxs-body">
 								<div class="row">
 									<div class="form-group col-sm-12">
 										<img  width="200px" height="200px" src="<?=base_url().'image/galeri/'.$FotoLama.'';?>" >
 									</div>
 								</div>
 							</div>
 						</section>
 			...
 			<script>
 				...
 				$('#UbahDataSistemDokumen').submit(function(e){
 					...
 					$.ajax({
 						url: base_url + 'data/galeri/UploadDokumenUbah',
 						type:"post",
