      ...
      <div class="b-b mb-10">
        <div class="row">
          <div class="col-sm-6 col-xs-12">
            <h1 class="h3 m-0">Laporan Tagihan Pemesanan</h1>
  ...
  <script>
    $('#SimpanData').on('submit', function (e) {
     ...
     $.ajax({
      type: "POST",
      url: base_url + 'data/Laporan/Tagihan',
      ...
      success: function (respone) {
       ...
       function () {
        window.location.href = base_url + 'data/Laporan/TagihanLaporan?date1='+respone.kode+'&date2='+respone.kode2
      });
      }else{
        swal({
         type: 'error',
