<section id="content">
					...
					<section class="boxs">
						<div class="boxs-header bg-green">
							<h3 class="custom-font">
								<strong>Form Tambah Tiket</strong></h3>
							</div>
								...
								<div class="boxs-body">
									<div class="row">
											...
											<div class="form-group">
												...
												<select class="form-control select2" name="maskapai" id="maskapai">
													...
													foreach ($variable->result_array() as $key ) {?>
														<option value="<?=$key['id'];?>"><?=$key['nama_maskapai'];?></option>
													<?php }?>
												</select>
											</div>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type='date' name="tanggalPesan"  id='tanggalPesan' class="form-control" autocomplete="off" />
											</div>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type='time' name="waktuPesan"  id='waktuPesan' class="form-control" autocomplete="off" />
											</div>
											<small class="text-danger ">Tanggal Berangkat!</small>
										</div>
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type='text'  name="kodePenerbanganPesawat"  id='kodePenerbanganPesawat' class="form-control" autocomplete="off" placeholder="ex: JKT-A-001" />
											</div>
									...
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
												<label>From</label>
												<input type='text'  name="from"  id='from' class="form-control" autocomplete="off" placeholder="ex: Jakarta" />
											</div>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type='text'  name="bandara"  id='bandara' class="form-control" autocomplete="off" placeholder="ex: SMB-II" />
											</div>
										...
										<div class="col-md-3">
											<div class="form-group">
												<label>To</label>
												<input type='text'  name="to"  id='to' class="form-control" autocomplete="off" placeholder="ex: Palembang" />
											</div>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type='text'  name="transit"  id='transit' class="form-control" autocomplete="off" placeholder="ex: SMB-II" />
											</div>
	...
	<script type="text/javascript">
		...
		$('#DataNya').on('submit', function (e) {
			...
			var DataNya = $(this);
			$.ajax({
				url: base_url + 'data/Ticketing/simpanTiket',
				type:"POST",
