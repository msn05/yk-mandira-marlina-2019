   <section id="search_container">
   	<div id="search">
   		<div class="tab-content">
   			<a href="<?=base_url().'welcome/pariwisata';?>" id="fa fa-back" class='btn btn-warning'>Kembali</a>
   			<div class="container margin_60">
   				<div class="row">
   					<div class="col-lg-12">
   						<?php if($CariData->num_rows() < 0 ){
               ...
               <tbody>
                 <tr>
                  ...
                  foreach ($CariData->result_array() as $key ) {
                   ...
                   <td>  <a href="<?=base_url().'welcome/Info?idData='.base64_encode($key['id_paket']).'&Notif=Umroh';?>" id="fa fa-back" class='btn btn-info'>INFO</a></td>
                 </tr>
               <?php }?>
             </tbody>
           </table>
