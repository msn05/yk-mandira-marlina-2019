   <section id="search_container">
   	<div id="search">
   		<div class="tab-content">
              ...
              <table class="table table-striped cart-list add_bottom_10">
               <thead>
                <tr>
                 <th>No</th>
                 <th>
           ...
           <tbody>
             <tr>
              ...
              foreach ($CariData->result_array() as $key ) {
               ...
               <?php if($key['tanggal_berangkat'] >= date('Y-m-d H:i:s')){?>
                 <td>  <a href="<?=base_url().'welcome/Info?idData='.base64_encode($key['id_paket']).'&Notif=Haji';?>" id="fa fa-back" class='btn btn-info'>PESAN</a></td>
               <?php }else{ echo "<td>Tidak Berlaku Lagi</td>"; }?>
             </tr>
           <?php }?>
         </tbody>
       </table>
