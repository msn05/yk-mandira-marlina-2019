							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<small class="text-danger">* Wajib Format PNG, JPEG, JPG size max 80kb</small>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										...
										<small class="text-danger">* Wajib Format PDF max 100kb</small>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<small class="text-danger">* Wajib Format PDF max 1 Mb</small>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										...
										<small class="text-danger">* Jika Ada Silakan Isi Format PDF max 1 mb</small>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input type="file" class="form-control" id="buku_nikah" name="buku_nikah" autocomplete="off" >
										<small class="text-danger">* Jika Ada Silakan Diisi Format PDF max 100kb</small>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	$('#SimpanData').submit(function(e){
		...
		$.ajax({
			url: base_url + 'data/PelangganPesan/UploadDokumenProses',
			type:"post",
