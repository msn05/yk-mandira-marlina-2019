		...
		<div class="row">
				...
				<div class="box_style_1">
					...
					<div class="col-lg-12 add_bottom_15">
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="pks" name="pks" placeholder="Pekerjaan  ex:pekerjaan">
									<small class="text-danger">* Wajib</small>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label>Wali Hakim</label>
									<input type="text" class="form-control" id="whk" name="whk" placeholder="Wali Hakim  ex:marlina">
									<small class="text-danger">* Wajib</small>
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<a href="<?=base_url().'welcome/umroh';?>" class='btn_1 yellow medium'> Kembali</a>
							</div>
						</div>
					</div>
				</div>
			...
			<script type="text/javascript">
				$('#PesanWithRegis').on('submit', function (e) {
					...
					$.ajax({
						url: base_url + 'data/PelangganPesan/simpanPesanan',
						type:"POST",
						...
						success: function (respone) {
							if (respone.status == 'success') {
								...
								function () {
									window.location.href = base_url + 'data/PelangganPesan/UploadDokumen?idData='+respone.kode+'&DataId='+respone.idDataNya;
								}
								);
							}else{
								swal({
				...
				$('#PesanNotRegis').on('submit', function (e) {
					...
					$.ajax({
						type: "POST",
						url: base_url + 'data/PelangganPesan/ProsesPesanTanpaRegis',
						...
						success: function (respone) {
							if (respone.status == 'success') {
								...
								function () {
									window.location.href = base_url + 'data/PelangganPesan/InformasiPemesanan?idData='+respone.kode+'&idDataNya='+respone.idData;
								});
							}else{
								swal({
									type: 'error',
