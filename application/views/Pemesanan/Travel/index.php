  		...
  		<div class="b-b mb-10">
  			<div class="row">
  				<div class="col-sm-6 col-xs-12">
  					<h1 class="h3 m-0">Pemesanan Travel</h1>
          ...
          <section class="boxs ">
           <div class="boxs-header">
            <h3 class="custom-font hb-cyan">
             <strong>Daftar Pemesanan Travel</strong></h3>
           </div>
           <?php if($Level == 1 || $Level == 3){?>
             <a href="<?=base_url().'data/Pemesanan/formTambahTravel';?>">
           ...
           <?php }elseif($Level == 2){?>
             ...
             <a href="<?=base_url().'welcome/umroh';?>" target='_blank'>
              <button class="btn btn-raised btn-primary">Tambah</button>
            </a>
         ...
         <tbody>
          ...
          foreach ($paket->result_array() as $key) {
            ...
            <tr>
             ...
             <td><?=$KodePemesanan['kode_pemesanan'] == $key['id_pemesanan'] ? '<a href="./../../data/Pembayaran/DataPembayaran?idData='.base64_encode($KodePemesanan['nomor_tagihan']).'">'.$KodePemesanan['nomor_tagihan'].'</a>' : 'Belum Ada Nomor Tagihan';?></td>
             <?php if($Level == 1){?>
               <td>
                ...
                <?php }?>
                <!--    <button type="button" class="btn btn-danger btn-raised fa fa-remove" title="Batalkan" id='Batal' name_id='<?=$key['id_pemesanan'];?>' name_pelanggan='<?=$key['nama_lengkap'];?>'></button> -->
              </td>
            <?php }?>
          </tr>
        <?php }?>
