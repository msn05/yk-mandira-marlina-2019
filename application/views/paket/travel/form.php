  <section id="content">
  	<div class="page page-ui-portlets">
  		...
  		<form method="POST" id="SimpanData" action="<?=base_url().'data/paket/simpanPaket';?>" >
  			<div class="row">
  				<div class="col-sm-12">
  					<section class="boxs">
            ...
            <div class="row">
              <div class="form-group col-sm-3">
               <div class="col-sm-12">
                ...
                <input type="number" class="form-control" id="lama_perjalanan" name="lama_perjalanan"placeholder="Lama Perjalanan" autocomplete="off" />
