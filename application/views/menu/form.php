      ...
      <h3 class="custom-font hb-green">
       ...
       <form method="POST" action="" id="DataNya" class="form-horizontal">
        ...
        <div class="form-group">
         ...
         <div class="col-sm-10">
          <input type="text" name="urlNya" class="form-control" id="urlNya" placeholder="alamat menu">
  ...
  <div class="form-group">
   ...
   <div class="col-sm-10">
    <select tabindex="3" name="ak" id="ak" class="chosen-select form-control" style="width: 100%;">
     ...
     <?php 
     foreach ($KategoriMenu as $key):?>
      <option value="<?=$key->id_kategori_menu;?>"><?=$key->nama_kategori;?></option>
    <?php endforeach;?>
  </select>
  <small class="text-danger ">Harap Memilih..!</small>
</div>
